...
export const calculatePriceTable = (
  ...
  // If yearly, convert using compound interest formula: (1+i_year)^(1/12) - 1
  // Or simple division if that's the specific banking convention desired, but compound is mathematically correct for equivalent rates.
  // We will use compound equivalent.
